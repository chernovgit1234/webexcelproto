...
export function renderBrandCell(td: HTMLTableCellElement, value: EnumTypeBrand): HTMLTableCellElement {
    ...
    switch (value) {
      ...
      td.style.backgroundColor = '#96fa00'
...
export function renderTdCommon(instance: Handsontable,row: number, td: HTMLTableCellElement, value: string): HTMLTableCellElement {
...
export function renderTypeTooltip(instance: Handsontable,row: number, td: HTMLTableCellElement, value: string): HTMLTableCellElement {
  ...
  td.style.textAlign = 'left'
  td.innerHTML = value; */
  return renderTdCommon(instance, row, td, value)
}
